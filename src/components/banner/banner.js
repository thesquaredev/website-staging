          ...
          <div className="banner__image col-lg-5">
            ...
            >
              ...
              <polyline
                ...
                strokeWidth="7"
              />
              <circle cx="318" cy="385.41" r="28" fill="#FF585B" />
              <circle cx="448" cy="240.41" r="28" fill="#FF585B" />
              <circle cx="578" cy="313.41" r="28" fill="#FF585B" />
              <circle cx="708" cy="89.41" r="28" fill="#FF585B" />
              <circle cx="958" cy="327.41" r="28" fill="#FF585B" />
              <ellipse
                cx="233.68"
                cy="722.61"
                rx="18.68"
